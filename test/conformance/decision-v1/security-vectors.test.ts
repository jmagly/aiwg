...
import { artifactPin, evaluateDecisionRuleset, executeQualificationPlan, JevDecisionAdapter, validateBinding, validateDefinition, verifyQualificationArtifacts,
  type AdapterObservation, type DecisionAdapter, type DecisionAdapterRequest, type DecisionBinding,
  type DecisionDefinition, type DecisionRuleset, type QualificationCaseExecutor } from '../../../src/decision/index.js';
...
const ids = ['C29', 'C30', 'C32', 'C34', 'C36', 'C39'] as const;
const roots: string[] = [];
