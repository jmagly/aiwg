...
import {
  evaluateDecisionRuleset, executeQualificationPlan, JevDecisionAdapter, verifyQualificationArtifacts,
...
const CASE_IDS = ['C11', 'C12', 'C13', 'C14', 'C15', 'C16', 'C17', 'C18'] as const;
const roots: string[] = [];
