...
Status: contract accepted; core library in `src/effects/` (#2717); verifier framework and built-in verifiers in `src/effects/verifiers/` (#2718); `aiwg effect` CLI in `src/cli/handlers/effect.ts` (#2720); tracker verifiers and adoption pending (#2719, #2721 onward)
