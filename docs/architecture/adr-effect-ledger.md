...
- Status: Accepted (contract, schemas, the `src/effects` core library, the verifier framework (#2718) and the `aiwg effect` CLI (#2720) committed; tracker verifiers and adoption pending #2719 onward)
- Date: 2026-09-24
