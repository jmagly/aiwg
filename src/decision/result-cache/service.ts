...
function savings(e: CachedResultEvidence): NonNullable<ResultCacheTelemetry['saved']> { return { inputTokens: e.usage.inputTokens ?? 0, outputTokens: e.usage.outputTokens ?? 0, costUsd: e.usage.costUsd ?? 0, latencyMs: e.durationMs }; }
