 ...
 */
export type Platform = 'antigravity' | 'claude' | 'codex' | 'copilot' | 'cursor' | 'deepseek-harness' | 'factory' | 'grokbot' | 'grok-build' | 'hermes' | 'muse' | 'opencode' | 'openclaw' | 'openhuman' | 'pi' | 'omp' | 'warp' | 'windsurf' | 'generic';
