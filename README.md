...
| Muse Code | `aiwg use all --provider muse` | `AGENTS.md` | `.agents/skills/` project; XDG user root at deploy time | Experimental; no aliases. See [Muse quickstart](docs/integrations/muse-quickstart.md). |
